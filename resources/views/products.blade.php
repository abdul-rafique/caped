<x-app-layout>
    <div class="grid grid-rows-2 gap-3 h-screen">
        <div class="grid grid-cols-2 gap-3 lg:grid-rows-6 lg:grid-cols-4">
            ...
            <x-tall-banner class="bg-indigo-300 row-span-4" style="background-image: url( {{ asset('images/modal-1.png') }} )">
            </x-tall-banner>
            <x-tall-banner class="bg-gray-300 row-span-4" style="background-image: url( {{ asset('images/modal-2.png') }} )" />
        </div>
